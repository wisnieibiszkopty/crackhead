...
if __name__ == "__main__":
    ...
    # W dniu swojej śmierci Juliusz Cezar prawie pokrzyżował plany spiskowców.
    # Jego żona bardzo źle się czuła i miała bardzo krwawe sny.
    # Poprosiła go o pozostanie w domu, ale ostatecznie Juliusz zdecydował się pojawić na obradach senatu.
    # Nawet w drodze na obrady otrzymał list z ostrzeżeniem, ale spieszył się i schował go na później.
    # crackCaesarCipher(
    ...
    # Z kodu Cezara korzystano nawet w 1915 roku.
    # Armia Imperium Rosyjskiego posługiwała się nim jako zamiennikiem dla jej bardziej skomplikowanych szyfrów,
    # które były zbyt trudne do opanowania dla rosyjskiego wojska, dzięki czemu niemieccy i
    # austriaccy kryptoanalitycy nie mieli większych problemów z odczytaniem tych wiadomości.
    # crackCaesarCipher(
